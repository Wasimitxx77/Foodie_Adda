...
namespace Foodie_Adda.Admin
{
    public partial class Product : System.Web.UI.Page
    {
        ...
        protected void btnAddOrUpdate_Click(object sender, EventArgs e)
        {
            ...
            int productId = string.IsNullOrEmpty(hdnId.Value) ? 0 : Convert.ToInt32(hdnId.Value);
            ...
            {
                if (Connection.Utils.IsValidExtension(fuProductImage.FileName))
                {
