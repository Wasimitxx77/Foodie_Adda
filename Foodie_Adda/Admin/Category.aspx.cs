...
namespace Foodie_Adda.Admin
{
    public partial class Category : System.Web.UI.Page
    {
        ...
        protected void btnAddOrUpdate_Click(object sender, EventArgs e)
        {
            ...
            int categoryId = string.IsNullOrEmpty(hdnId.Value) ? 0 : Convert.ToInt32(hdnId.Value);

            // Initialize the connection and command before using cmd
            ...
            {
                if (Connection.Utils.IsValidExtension(fuCategoryImage.FileName))
                {
