<%@ Page Title="" Language="C#" MasterPageFile="~/User/Home.Master" AutoEventWireup="true" CodeBehind="Profile.aspx.cs" Inherits="Foodie_Adda.User.Profile" %>

<%@ Import Namespace="Foodie_Adda" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">

    <% 
        string imageUrl = string.Empty; // Initialize imageUrl with a default value
                            ...
                            <div class="card-title mb-4">
                                <div class="d-flex justify-content-start">
                                    <div class="image-container">
                                        <img src='<%= Connection.Utils.GetImageUrl(imageUrl) %>' id="imgProfile" style="width: 150px; height: 150px;"
                                            class="img-thumbnail" />
